...
`「フェイドインフェイドアウト」`、`「縦方向のフリップ」`、`「横方向のフリップ」`の3種類のスライドショータイプに対応しています（デフォルトはフェイドインフェイドアウトタイプ）。
...
スライドショー動画広告のスライドショーのタイプを指定します。フェイドインフェイドアウトタイプなら`'fade'`、Y軸を軸に横方向へのフリップタイプなら`'flipY'`、X軸を軸とする縦方向のフリップタイプなら`'flipX'`を指定します。デフォルト値は、`fade`。
